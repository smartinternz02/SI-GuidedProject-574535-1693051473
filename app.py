...
app = Flask(__name__)
app.secret_key = '_pcm'
conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=2f3279a5-73d1-4859-88f0-a6c3e6b4b907.c3n41cmd0nqnrk39u98g.databases.appdomain.cloud;PORT=30756;UID=lxx72302;PWD=MJ6QAHXitLq1wKCE;SECURITY=SSL;SSLCERTIFICATE=DigiCertGlobalRootCA.crt",'','')
